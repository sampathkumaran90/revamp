...
from pipeline.components.transform.component import TransformComponent

_pipeline_name = 'cifar10_pipeline_pytorch'
_cifar10_root = os.path.join(os.environ['HOME'], "pipeline/examples/cifar10")
_data_root = ""
...
def _create_pipeline(pipeline_name, pipeline_root, data_root, module_file):
    ...
    transform = TransformComponent(module_file = module_file)
